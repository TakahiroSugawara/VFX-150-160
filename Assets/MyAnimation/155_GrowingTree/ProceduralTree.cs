...
namespace ProceduralModeling {
	...
	public class ProceduralTree : ProceduralModelingBase
    {
		...
		[SerializeField, Range(2, 7)] protected float generations = 5;
        ...
        [Range(0.0f, 0.35f)] public float AN_bendDegree = 0.1f;
        [SerializeField, Range(0.5f, 0.99f)] public float AN_lengthAttenuation = 0.9f;
        [SerializeField, Range(0f, 45f)] public float AN_growthAngleMax = 15f;

        public static Mesh Build(TreeData data, float generations, float length, float radius) {
			data.Setup();
		...
		{
            data.bendDegree = AN_bendDegree;
            data.lengthAttenuation = AN_lengthAttenuation;
            data.growthAngleMax = AN_growthAngleMax;
    ...
    public class TreeData
    {
        ...
        [SerializeField,Range(0.5f, 0.99f)] public float lengthAttenuation = 0.9f, radiusAttenuation = 0.6f;
		[SerializeField, Range(1, 3)] public int branchesMin = 1, branchesMax = 3;
        [SerializeField, Range(-45f, 0f)] public float growthAngleMin = -15f;
        [SerializeField, Range(0f, 45f)] public float growthAngleMax = 15f;
        [SerializeField, Range(1f, 10f)] public float growthAngleScale = 4f;
		[SerializeField, Range(4, 20)] public int heightSegments = 10, radialSegments = 8;
		[SerializeField, Range(0.0f, 0.35f)] public float bendDegree = 0.1f;
	...
	public class TreeBranch {
		public float Generation { get { return generation; } }
		...
		// 根元のコンストラクタ
		public TreeBranch(float generations, float length, float radius, TreeData data) : this(generations, generations, Vector3.zero, Vector3.up, Vector3.right, Vector3.back, length, radius, 0f, data) {
		}

		protected TreeBranch(float generation, float generations, Vector3 from, Vector3 tangent, Vector3 normal, Vector3 binormal, float length, float radius, float offset, TreeData data) {
